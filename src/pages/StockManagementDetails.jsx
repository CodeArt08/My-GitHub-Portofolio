...
const StockManagementDetails = () => {
    const slides = [
        ...
        {
            image: getAssetPath("/assets/images/stock2.png"),
        ...
        {
            image: getAssetPath("/assets/images/stock3.png"),
        ...
        {
            image: getAssetPath("/assets/images/stock4.png"),
            title: "Registre des Dotations aux Établissements",
        ...
        {
            image: getAssetPath("/assets/images/stock5.png"),
        ...
        {
            image: getAssetPath("/assets/images/stock6.png"),
